...
describe('Magmite Card', () => {
  describe('Base Card Properties', () => {
    ...
    test('should have correct card properties', () => {
      ...
      expect(MAGMITE.type).toBe('Beast');
  ...
  describe('Base Ability - Hardened Shell', () => {
    ...
    test('should have correct trigger', () => {
      expect(MAGMITE.abilities[0].trigger).toBe(AbilityTrigger.WhileOnField);
    });
  ...
  describe.skip('Level 4 Upgrade - Molten Armor', () => {
  ...
  describe.skip('Level 7 Upgrade - Eruption', () => {
  ...
  describe.skip('Level 9 Upgrade - Obsidian Carapace', () => {
